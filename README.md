...
mkdir data
cd data
git clone -b TriLepNano_FakeFactor https://github.com/jingyan95/Analysis.git TopLFV
cd .. (in CMSSW/src/)
git clone -b TriLepNano_FakeFactor https://github.com/jingyan95/nanoAOD-tools.git PhysicsTools/NanoAODTools
scram b -j 5
cd data/TopLFV
make all
