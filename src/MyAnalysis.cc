...
void MyAnalysis::Loop(TString fname, TString data, TString dataset ,TString year, TString run, float xs, float lumi, float Nevent)
{
  ...
  std::vector<TString> regions{"lll","lllOnZ","lllOffZ","lllOffZB0","lllOffZB1", "lllOffZBgeq2", "lllOffZMetl20", "lllOffZMetg20", "lllOffZMetg20Jetgeq1", "lllOffZMetg20Jet1B1", "lllOffZMetg20Jet2B1","lllOffZMetg20Jetgeq1Bleq1","lllOnZMetg20Jetgeq1Bleq1"};
...
600 ,100 ,7     ,4       ,7     ,7      ,150};
  ...
  for (int i=0;i<(int)channels.size();++i){
    ...
    //Fake Factor Implementation
    Double_t ptBinsFF[8] = {20., 23., 27., 32., 38., 45., 65., 100.};

    std::vector<TString> channelsFF{"e","mu","emu"};
    ...
    Dim24 HistsAR1(channelsFF.size(),Dim23(2,Dim22(etaregs.size(),Dim21(varsFF.size()))));
    Dim35 HistsAR2(channelsFF.size(),Dim34(2,Dim33(etaregs.size(),Dim32(etaregs.size(),Dim31(varsFF.size())))));
        ...
        for (int k=0;k<2;++k){
            for (int j=0;j<(int)etaregs.size();++j){
                for (int l=0;l<(int)varsFF.size();++l){
                    ...
                    name<<"AR1_2D_"<<channelsFF[i]<<"_"<<regions[k]<<"_"<<etaregs[j]<<"_"<<varsFF[l];
                    ...
                    for (int m=0;m<(int)etaregs.size();++m){
                        name<<"AR2_3D_"<<channelsFF[i]<<"_"<<regions[k]<<"_"<<etaregs[j]<<"_"<<etaregs[m]<<"_"<<varsFF[l];
  ...
  bool ARveto;//For application, we only study emul channel
  int ch;
  int ch1;
  int nAccept=0;
  int nbjet;
...
// electron
    for (UInt_t l=0;l< nElectron ;l++){
      ...
      if((int) Electron_cutBased[l] < 1) continue; //  1 = veto for cut based ID, this cut accept veto, loose, medium, tight electrons.
      ...
      if (Electron_mvaTOP[l]>0.9){
        ...
        (*selectedLeptons_copy)[selectedLeptons_copy->size()-1]->setTag();
        nTight++;
      }
...
// Muon
    ...
    if (selectedLeptons->size()==3 && ((*selectedLeptons)[0]->lep_ + (*selectedLeptons)[1]->lep_ + (*selectedLeptons)[2]->lep_ == 3 ||
        (*selectedLeptons)[0]->lep_ + (*selectedLeptons)[1]->lep_ + (*selectedLeptons)[2]->lep_ == 30) && nTight<3){
        ARveto=true;
    }
    ...
    // trilepton selection
    if(selectedLeptons->size()!=3 || ARveto ||
       ((*selectedLeptons)[0]->pt_ <30) || !((*selectedLeptons)[0]->isTag) ||
    ...
    if (ch==1&&!compete){
      if(ch1==0||ch1==1){
        if ((*selectedLeptons_copy)[0]->isTag&&(*selectedLeptons_copy)[1]->isTag){
        ...
        if ((*selectedLeptons_copy)[1]->isTag&&(*selectedLeptons_copy)[2]->isTag){
    ...
    if (ch==0||ch==2){
        if ((*selectedLeptons_copy)[0]->isTag&&(*selectedLeptons_copy)[2]->isTag){
    ...
    if (data == "mc" && (year == "2016" || year == "2017")) { 
      ...
      weightPre_Up = 1;
      weightPre_Dn = 1;
      if ( L1PreFiringWeight_Nom >0 && L1PreFiringWeight_Nom <= 3 ){
      	weightPre =  L1PreFiringWeight_Nom;
      }
      if ( L1PreFiringWeight_Up >=0 && L1PreFiringWeight_Up <= 3 ){
        weightPre_Up =  L1PreFiringWeight_Up;
      }
      if ( L1PreFiringWeight_Dn >=0 && L1PreFiringWeight_Dn <= 3 ){
        weightPre_Dn =  L1PreFiringWeight_Dn;
      }
      weight_prefiring = weightPre;
      nominalWeights[7] = weightPre;
      sysUpWeights[7] = weightPre_Up;
      sysDownWeights[7] = weightPre_Dn;
    }
    if (data == "mc" && ifTopPt) {
    ...
    Hists[ch][0][19]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).M(),weight_lep);
    Hists[ch][0][20]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).Pt(),weight_lep);
    Hists[ch][0][21]->Fill(((*selectedLeptons_copy)[0]->p4_).Pt()+((*selectedLeptons_copy)[1]->p4_).Pt()+((*selectedLeptons_copy)[2]->p4_).Pt(),weight_lep);
    Hists[ch][0][22]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).Mt(),weight_lep);
    ...
    Hists[ch][0][31]->Fill(Zmass,weight_lep);
    Hists[ch][0][32]->Fill(Zpt,weight_lep);
    Hists[ch][0][33]->Fill(ZDr,weight_lep);
    Hists[ch][0][34]->Fill(ZDphi,weight_lep);
    Hists[ch][0][35]->Fill(LFVTopmass,weight_lep);
    Hists[ch][0][36]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_).M(),weight_lep);
    Hists[ch][0][37]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_).Pt(),weight_lep);
    Hists[ch][0][38]->Fill(deltaR((*selectedLeptons_copy)[0]->eta_,(*selectedLeptons_copy)[0]->phi_,(*selectedLeptons_copy)[1]->eta_,(*selectedLeptons_copy)[1]->phi_),weight_lep);
    Hists[ch][0][39]->Fill(deltaPhi((*selectedLeptons_copy)[0]->phi_,(*selectedLeptons_copy)[1]->phi_),weight_lep);
    Hists[ch][0][40]->Fill(Ht,weight_lep);
    Hists[ch][0][41]->Fill(Ms,weight_lep);
    Hists[ch][0][42]->Fill(ZlDr,weight_lep);
    Hists[ch][0][43]->Fill(ZlDphi,weight_lep);
    Hists[ch][0][44]->Fill(JeDr,weight_lep);
    Hists[ch][0][45]->Fill(JmuDr,weight_lep);
    Hists[ch][0][46]->Fill(tM,weight_lep);
    ...
    Hists[ch][1][19]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).M(),weight_lep);
    Hists[ch][1][20]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).Pt(),weight_lep);
    Hists[ch][1][21]->Fill(((*selectedLeptons_copy)[0]->p4_).Pt()+((*selectedLeptons_copy)[1]->p4_).Pt()+((*selectedLeptons_copy)[2]->p4_).Pt(),weight_lep);
    Hists[ch][1][22]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).Mt(),weight_lep);
    ...
    Hists[ch][1][32]->Fill(Zpt,weight_lep);
    Hists[ch][1][33]->Fill(ZDr,weight_lep);
    Hists[ch][1][34]->Fill(ZDphi,weight_lep);
    Hists[ch][1][35]->Fill(LFVTopmass,weight_lep);
    Hists[ch][1][36]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_).M(),weight_lep);
    Hists[ch][1][37]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_).Pt(),weight_lep);
    Hists[ch][1][38]->Fill(deltaR((*selectedLeptons_copy)[0]->eta_,(*selectedLeptons_copy)[0]->phi_,(*selectedLeptons_copy)[1]->eta_,(*selectedLeptons_copy)[1]->phi_),weight_lep);
    Hists[ch][1][39]->Fill(deltaPhi((*selectedLeptons_copy)[0]->phi_,(*selectedLeptons_copy)[1]->phi_),weight_lep);
    Hists[ch][1][40]->Fill(Ht,weight_lep);
    Hists[ch][1][41]->Fill(Ms,weight_lep);
    Hists[ch][1][42]->Fill(ZlDr,weight_lep);
    Hists[ch][1][43]->Fill(ZlDphi,weight_lep);
    Hists[ch][1][44]->Fill(JeDr,weight_lep);
    Hists[ch][1][45]->Fill(JmuDr,weight_lep);
    Hists[ch][1][46]->Fill(tM,weight_lep);
    }
    //Off Z
    ...
    Hists[ch][2][19]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).M(),weight_lep);
    Hists[ch][2][20]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).Pt(),weight_lep);
    Hists[ch][2][21]->Fill(((*selectedLeptons_copy)[0]->p4_).Pt()+((*selectedLeptons_copy)[1]->p4_).Pt()+((*selectedLeptons_copy)[2]->p4_).Pt(),weight_lep);
    Hists[ch][2][22]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).Mt(),weight_lep);
    ...
    Hists[ch][2][31]->Fill(Zmass,weight_lep);
    Hists[ch][2][32]->Fill(Zpt,weight_lep);
    Hists[ch][2][33]->Fill(ZDr,weight_lep);
    Hists[ch][2][34]->Fill(ZDphi,weight_lep);
    Hists[ch][2][35]->Fill(LFVTopmass,weight_lep);
    Hists[ch][2][36]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_).M(),weight_lep);
    Hists[ch][2][37]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_).Pt(),weight_lep);
    Hists[ch][2][38]->Fill(deltaR((*selectedLeptons_copy)[0]->eta_,(*selectedLeptons_copy)[0]->phi_,(*selectedLeptons_copy)[1]->eta_,(*selectedLeptons_copy)[1]->phi_),weight_lep);
    Hists[ch][2][39]->Fill(deltaPhi((*selectedLeptons_copy)[0]->phi_,(*selectedLeptons_copy)[1]->phi_),weight_lep);
    Hists[ch][2][40]->Fill(Ht,weight_lep);
    Hists[ch][2][41]->Fill(Ms,weight_lep);
    Hists[ch][2][42]->Fill(ZlDr,weight_lep);
    Hists[ch][2][43]->Fill(ZlDphi,weight_lep);
    Hists[ch][2][44]->Fill(JeDr,weight_lep);
    Hists[ch][2][45]->Fill(JmuDr,weight_lep);
    Hists[ch][2][46]->Fill(tM,weight_lep);
    }
    ...
    Hists[ch][5][36]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_).M(),weight_lepB);
    Hists[ch][5][37]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_).Pt(),weight_lepB);
    Hists[ch][5][38]->Fill(deltaR((*selectedLeptons_copy)[0]->eta_,(*selectedLeptons_copy)[0]->phi_,(*selectedLeptons_copy)[1]->eta_,(*selectedLeptons_copy)[1]->phi_),weight_lepB);
    Hists[ch][5][39]->Fill(deltaPhi((*selectedLeptons_copy)[0]->phi_,(*selectedLeptons_copy)[1]->phi_),weight_lepB);
    Hists[ch][5][40]->Fill(Ht,weight_lepB);
    Hists[ch][5][41]->Fill(Ms,weight_lepB);
    Hists[ch][5][42]->Fill(ZlDr,weight_lepB);
    Hists[ch][5][43]->Fill(ZlDphi,weight_lepB);
    ...
    Hists[ch][6][19]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).M(),weight_lep);
    Hists[ch][6][20]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).Pt(),weight_lep);
    Hists[ch][6][21]->Fill(((*selectedLeptons_copy)[0]->p4_).Pt()+((*selectedLeptons_copy)[1]->p4_).Pt()+((*selectedLeptons_copy)[2]->p4_).Pt(),weight_lep);
    Hists[ch][6][22]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).Mt(),weight_lep);
    ...
    Hists[ch][6][27]->Fill(nbjet,weight_lep);
    Hists[ch][6][28]->Fill(MET_pt0,weight_lep);
    Hists[ch][6][29]->Fill(MET_phi0,weight_lep);
    Hists[ch][6][30]->Fill(Pileup_nTrueInt,weight_lep);
    Hists[ch][6][31]->Fill(Zmass,weight_lep);
    Hists[ch][6][32]->Fill(Zpt,weight_lep);
    Hists[ch][6][33]->Fill(ZDr,weight_lep);
    Hists[ch][6][34]->Fill(ZDphi,weight_lep);
    Hists[ch][6][35]->Fill(LFVTopmass,weight_lep);
    Hists[ch][6][36]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_).M(),weight_lep);
    Hists[ch][6][37]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_).Pt(),weight_lep);
    Hists[ch][6][38]->Fill(deltaR((*selectedLeptons_copy)[0]->eta_,(*selectedLeptons_copy)[0]->phi_,(*selectedLeptons_copy)[1]->eta_,(*selectedLeptons_copy)[1]->phi_),weight_lep);
    Hists[ch][6][39]->Fill(deltaPhi((*selectedLeptons_copy)[0]->phi_,(*selectedLeptons_copy)[1]->phi_),weight_lep);
    Hists[ch][6][40]->Fill(Ht,weight_lep);
    Hists[ch][6][41]->Fill(Ms,weight_lep);
    Hists[ch][6][42]->Fill(ZlDr,weight_lep);
    Hists[ch][6][43]->Fill(ZlDphi,weight_lep);
    Hists[ch][6][44]->Fill(JeDr,weight_lep);
    Hists[ch][6][45]->Fill(JmuDr,weight_lep);
    Hists[ch][6][46]->Fill(tM,weight_lep);
    }
    ...
    Hists[ch][7][19]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).M(),weight_lep);
    Hists[ch][7][20]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).Pt(),weight_lep);
    Hists[ch][7][21]->Fill(((*selectedLeptons_copy)[0]->p4_).Pt()+((*selectedLeptons_copy)[1]->p4_).Pt()+((*selectedLeptons_copy)[2]->p4_).Pt(),weight_lep);
    Hists[ch][7][22]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).Mt(),weight_lep);
    ...
    Hists[ch][7][31]->Fill(Zmass,weight_lep);
    Hists[ch][7][32]->Fill(Zpt,weight_lep);
    Hists[ch][7][33]->Fill(ZDr,weight_lep);
    Hists[ch][7][34]->Fill(ZDphi,weight_lep);
    Hists[ch][7][35]->Fill(LFVTopmass,weight_lep);
    Hists[ch][7][36]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_).M(),weight_lep);
    Hists[ch][7][37]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_).Pt(),weight_lep);
    Hists[ch][7][38]->Fill(deltaR((*selectedLeptons_copy)[0]->eta_,(*selectedLeptons_copy)[0]->phi_,(*selectedLeptons_copy)[1]->eta_,(*selectedLeptons_copy)[1]->phi_),weight_lep);
    Hists[ch][7][39]->Fill(deltaPhi((*selectedLeptons_copy)[0]->phi_,(*selectedLeptons_copy)[1]->phi_),weight_lep);
    Hists[ch][7][40]->Fill(Ht,weight_lep);
    Hists[ch][7][41]->Fill(Ms,weight_lep);
    Hists[ch][7][42]->Fill(ZlDr,weight_lep);
    Hists[ch][7][43]->Fill(ZlDphi,weight_lep);
    Hists[ch][7][44]->Fill(JeDr,weight_lep);
    Hists[ch][7][45]->Fill(JmuDr,weight_lep);
    Hists[ch][7][46]->Fill(tM,weight_lep);
    }

    if(MET_pt0>20 && !OnZ && selectedJets->size()>0){
    Hists[ch][8][0]->Fill((*selectedLeptons)[0]->pt_,weight_lep);
    Hists[ch][8][1]->Fill((*selectedLeptons)[0]->eta_,weight_lep);
    Hists[ch][8][2]->Fill((*selectedLeptons)[0]->phi_,weight_lep);
    Hists[ch][8][3]->Fill((*selectedLeptons)[1]->pt_,weight_lep);
    Hists[ch][8][4]->Fill((*selectedLeptons)[1]->eta_,weight_lep);
    Hists[ch][8][5]->Fill((*selectedLeptons)[1]->phi_,weight_lep);
    Hists[ch][8][6]->Fill((*selectedLeptons)[2]->pt_,weight_lep);
    Hists[ch][8][7]->Fill((*selectedLeptons)[2]->eta_,weight_lep);
    Hists[ch][8][8]->Fill((*selectedLeptons)[2]->phi_,weight_lep);
    Hists[ch][8][9]->Fill((*selectedLeptons_copy)[0]->pt_,weight_lep);
    Hists[ch][8][10]->Fill((*selectedLeptons_copy)[0]->eta_,weight_lep);
    Hists[ch][8][11]->Fill((*selectedLeptons_copy)[0]->phi_,weight_lep);
    Hists[ch][8][12]->Fill((*selectedLeptons_copy)[1]->pt_,weight_lep);
    Hists[ch][8][13]->Fill((*selectedLeptons_copy)[1]->eta_,weight_lep);
    Hists[ch][8][14]->Fill((*selectedLeptons_copy)[1]->phi_,weight_lep);
    Hists[ch][8][15]->Fill((*selectedLeptons_copy)[2]->pt_,weight_lep);
    Hists[ch][8][16]->Fill((*selectedLeptons_copy)[2]->eta_,weight_lep);
    Hists[ch][8][17]->Fill((*selectedLeptons_copy)[2]->phi_,weight_lep);
    Hists[ch][8][18]->Fill(Topmass,weight_lep);
    Hists[ch][8][19]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).M(),weight_lep);
    Hists[ch][8][20]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).Pt(),weight_lep);
    Hists[ch][8][21]->Fill(((*selectedLeptons_copy)[0]->p4_).Pt()+((*selectedLeptons_copy)[1]->p4_).Pt()+((*selectedLeptons_copy)[2]->p4_).Pt(),weight_lep);
    Hists[ch][8][22]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).Mt(),weight_lep);
    if(selectedJets->size()>0) Hists[ch][8][23]->Fill((*selectedJets)[0]->pt_,weight_lep);
    if(selectedJets->size()>0) Hists[ch][8][24]->Fill((*selectedJets)[0]->eta_,weight_lep);
    if(selectedJets->size()>0) Hists[ch][8][25]->Fill((*selectedJets)[0]->phi_,weight_lep);
    Hists[ch][8][26]->Fill(selectedJets->size(),weight_lep);
    Hists[ch][8][27]->Fill(nbjet,weight_lepB);
    Hists[ch][8][28]->Fill(MET_pt0,weight_lep);
    Hists[ch][8][29]->Fill(MET_phi0,weight_lep);
    Hists[ch][8][30]->Fill(Pileup_nTrueInt,weight_lep);
    Hists[ch][8][31]->Fill(Zmass,weight_lep);
    Hists[ch][8][32]->Fill(Zpt,weight_lep);
    Hists[ch][8][33]->Fill(ZDr,weight_lep);
    Hists[ch][8][34]->Fill(ZDphi,weight_lep);
    Hists[ch][8][35]->Fill(LFVTopmass,weight_lep);
    Hists[ch][8][36]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_).M(),weight_lep);
    Hists[ch][8][37]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_).Pt(),weight_lep);
    Hists[ch][8][38]->Fill(deltaR((*selectedLeptons_copy)[0]->eta_,(*selectedLeptons_copy)[0]->phi_,(*selectedLeptons_copy)[1]->eta_,(*selectedLeptons_copy)[1]->phi_),weight_lep);
    Hists[ch][8][39]->Fill(deltaPhi((*selectedLeptons_copy)[0]->phi_,(*selectedLeptons_copy)[1]->phi_),weight_lep);
    Hists[ch][8][40]->Fill(Ht,weight_lep);
    Hists[ch][8][41]->Fill(Ms,weight_lep);
    Hists[ch][8][42]->Fill(ZlDr,weight_lep);
    Hists[ch][8][43]->Fill(ZlDphi,weight_lep);
    Hists[ch][8][44]->Fill(JeDr,weight_lep);
    Hists[ch][8][45]->Fill(JmuDr,weight_lep);
    Hists[ch][8][46]->Fill(tM,weight_lep);
    }
    ...
    //For now we only study sys for lll region
    for (int n=0;n<8;++n){
    ...
    HistsSysUp[ch][0][9][n]->Fill((*selectedLeptons_copy)[0]->pt_,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][0][10][n]->Fill((*selectedLeptons_copy)[0]->eta_,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][0][11][n]->Fill((*selectedLeptons_copy)[0]->phi_,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][0][12][n]->Fill((*selectedLeptons_copy)[1]->pt_,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][0][13][n]->Fill((*selectedLeptons_copy)[1]->eta_,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][0][14][n]->Fill((*selectedLeptons_copy)[1]->phi_,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][0][15][n]->Fill((*selectedLeptons_copy)[2]->pt_,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][0][16][n]->Fill((*selectedLeptons_copy)[2]->eta_,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][0][17][n]->Fill((*selectedLeptons_copy)[2]->phi_,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][0][18][n]->Fill(Topmass,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][0][19][n]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).M(),weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][0][20][n]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).Pt(),weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][0][21][n]->Fill(((*selectedLeptons_copy)[0]->p4_).Pt()+((*selectedLeptons_copy)[1]->p4_).Pt()+((*selectedLeptons_copy)[2]->p4_).Pt(),weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][0][22][n]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).Mt(),weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    ...
    HistsSysUp[ch][0][31][n]->Fill(Zmass,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][0][32][n]->Fill(Zpt,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][0][33][n]->Fill(ZDr,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][0][34][n]->Fill(ZDphi,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][0][35][n]->Fill(LFVTopmass,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][0][36][n]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_).M(),weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][0][37][n]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_).Pt(),weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][0][38][n]->Fill(deltaR((*selectedLeptons_copy)[0]->eta_,(*selectedLeptons_copy)[0]->phi_,(*selectedLeptons_copy)[1]->eta_,(*selectedLeptons_copy)[1]->phi_),weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][0][39][n]->Fill(deltaPhi((*selectedLeptons_copy)[0]->phi_,(*selectedLeptons_copy)[1]->phi_),weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][0][40][n]->Fill(Ht,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][0][41][n]->Fill(Ms,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][0][42][n]->Fill(ZlDr,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][0][43][n]->Fill(ZlDphi,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][0][44][n]->Fill(JeDr,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][0][45][n]->Fill(JmuDr,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][0][46][n]->Fill(tM,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    ...
    HistsSysDown[ch][0][9][n]->Fill((*selectedLeptons_copy)[0]->pt_,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][0][10][n]->Fill((*selectedLeptons_copy)[0]->eta_,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][0][11][n]->Fill((*selectedLeptons_copy)[0]->phi_,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][0][12][n]->Fill((*selectedLeptons_copy)[1]->pt_,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][0][13][n]->Fill((*selectedLeptons_copy)[1]->eta_,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][0][14][n]->Fill((*selectedLeptons_copy)[1]->phi_,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][0][15][n]->Fill((*selectedLeptons_copy)[2]->pt_,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][0][16][n]->Fill((*selectedLeptons_copy)[2]->eta_,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][0][17][n]->Fill((*selectedLeptons_copy)[2]->phi_,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][0][18][n]->Fill(Topmass,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][0][19][n]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).M(),weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][0][20][n]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).Pt(),weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][0][21][n]->Fill(((*selectedLeptons_copy)[0]->p4_).Pt()+((*selectedLeptons_copy)[1]->p4_).Pt()+((*selectedLeptons_copy)[2]->p4_).Pt(),weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][0][22][n]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).Mt(),weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    ...
    HistsSysDown[ch][0][31][n]->Fill(Zmass,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][0][32][n]->Fill(Zpt,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][0][33][n]->Fill(ZDr,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][0][34][n]->Fill(ZDphi,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][0][35][n]->Fill(LFVTopmass,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][0][36][n]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_).M(),weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][0][37][n]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_).Pt(),weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][0][38][n]->Fill(deltaR((*selectedLeptons_copy)[0]->eta_,(*selectedLeptons_copy)[0]->phi_,(*selectedLeptons_copy)[1]->eta_,(*selectedLeptons_copy)[1]->phi_),weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][0][39][n]->Fill(deltaPhi((*selectedLeptons_copy)[0]->phi_,(*selectedLeptons_copy)[1]->phi_),weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][0][40][n]->Fill(Ht,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][0][41][n]->Fill(Ms,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][0][42][n]->Fill(ZlDr,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][0][43][n]->Fill(ZlDphi,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][0][44][n]->Fill(JeDr,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][0][45][n]->Fill(JmuDr,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][0][46][n]->Fill(tM,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    ...
    HistsSysUp[ch][1][6][n]->Fill((*selectedLeptons)[2]->pt_,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][7][n]->Fill((*selectedLeptons)[2]->eta_,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][8][n]->Fill((*selectedLeptons)[2]->phi_,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][9][n]->Fill((*selectedLeptons_copy)[0]->pt_,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][10][n]->Fill((*selectedLeptons_copy)[0]->eta_,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][11][n]->Fill((*selectedLeptons_copy)[0]->phi_,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][12][n]->Fill((*selectedLeptons_copy)[1]->pt_,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][13][n]->Fill((*selectedLeptons_copy)[1]->eta_,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][14][n]->Fill((*selectedLeptons_copy)[1]->phi_,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][15][n]->Fill((*selectedLeptons_copy)[2]->pt_,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][16][n]->Fill((*selectedLeptons_copy)[2]->eta_,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][17][n]->Fill((*selectedLeptons_copy)[2]->phi_,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][18][n]->Fill(Topmass,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][19][n]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).M(),weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][20][n]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).Pt(),weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][21][n]->Fill(((*selectedLeptons_copy)[0]->p4_).Pt()+((*selectedLeptons_copy)[1]->p4_).Pt()+((*selectedLeptons_copy)[2]->p4_).Pt(),weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][22][n]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).Mt(),weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    if(selectedJets->size()>0) HistsSysUp[ch][1][23][n]->Fill((*selectedJets)[0]->pt_,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    if(selectedJets->size()>0) HistsSysUp[ch][1][24][n]->Fill((*selectedJets)[0]->eta_,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    if(selectedJets->size()>0) HistsSysUp[ch][1][25][n]->Fill((*selectedJets)[0]->phi_,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][26][n]->Fill(selectedJets->size(),weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][27][n]->Fill(nbjet,weight_lepB * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][28][n]->Fill(MET_pt0,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][29][n]->Fill(MET_phi0,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][30][n]->Fill(Pileup_nTrueInt,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][31][n]->Fill(Zmass,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][32][n]->Fill(Zpt,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][33][n]->Fill(ZDr,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][34][n]->Fill(ZDphi,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][35][n]->Fill(LFVTopmass,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][36][n]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_).M(),weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][37][n]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_).Pt(),weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][38][n]->Fill(deltaR((*selectedLeptons_copy)[0]->eta_,(*selectedLeptons_copy)[0]->phi_,(*selectedLeptons_copy)[1]->eta_,(*selectedLeptons_copy)[1]->phi_),weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][39][n]->Fill(deltaPhi((*selectedLeptons_copy)[0]->phi_,(*selectedLeptons_copy)[1]->phi_),weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][40][n]->Fill(Ht,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][41][n]->Fill(Ms,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][42][n]->Fill(ZlDr,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][43][n]->Fill(ZlDphi,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][44][n]->Fill(JeDr,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][45][n]->Fill(JmuDr,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    HistsSysUp[ch][1][46][n]->Fill(tM,weight_lep * (sysUpWeights[n]/nominalWeights[n]));
    ...
    HistsSysDown[ch][1][6][n]->Fill((*selectedLeptons)[2]->pt_,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][7][n]->Fill((*selectedLeptons)[2]->eta_,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][8][n]->Fill((*selectedLeptons)[2]->phi_,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][9][n]->Fill((*selectedLeptons_copy)[0]->pt_,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][10][n]->Fill((*selectedLeptons_copy)[0]->eta_,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][11][n]->Fill((*selectedLeptons_copy)[0]->phi_,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][12][n]->Fill((*selectedLeptons_copy)[1]->pt_,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][13][n]->Fill((*selectedLeptons_copy)[1]->eta_,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][14][n]->Fill((*selectedLeptons_copy)[1]->phi_,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][15][n]->Fill((*selectedLeptons_copy)[2]->pt_,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][16][n]->Fill((*selectedLeptons_copy)[2]->eta_,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][17][n]->Fill((*selectedLeptons_copy)[2]->phi_,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][18][n]->Fill(Topmass,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][19][n]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).M(),weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][20][n]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).Pt(),weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][21][n]->Fill(((*selectedLeptons_copy)[0]->p4_).Pt()+((*selectedLeptons_copy)[1]->p4_).Pt()+((*selectedLeptons_copy)[2]->p4_).Pt(),weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][22][n]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_ + (*selectedLeptons_copy)[2]->p4_).Mt(),weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    if(selectedJets->size()>0) HistsSysDown[ch][1][23][n]->Fill((*selectedJets)[0]->pt_,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    if(selectedJets->size()>0) HistsSysDown[ch][1][24][n]->Fill((*selectedJets)[0]->eta_,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    if(selectedJets->size()>0) HistsSysDown[ch][1][25][n]->Fill((*selectedJets)[0]->phi_,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][26][n]->Fill(selectedJets->size(),weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][27][n]->Fill(nbjet,weight_lepB * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][28][n]->Fill(MET_pt0,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][29][n]->Fill(MET_phi0,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][30][n]->Fill(Pileup_nTrueInt,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][31][n]->Fill(Zmass,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][32][n]->Fill(Zpt,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][33][n]->Fill(ZDr,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][34][n]->Fill(ZDphi,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][35][n]->Fill(LFVTopmass,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][36][n]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_).M(),weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][37][n]->Fill(((*selectedLeptons_copy)[0]->p4_ + (*selectedLeptons_copy)[1]->p4_).Pt(),weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][38][n]->Fill(deltaR((*selectedLeptons_copy)[0]->eta_,(*selectedLeptons_copy)[0]->phi_,(*selectedLeptons_copy)[1]->eta_,(*selectedLeptons_copy)[1]->phi_),weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][39][n]->Fill(deltaPhi((*selectedLeptons_copy)[0]->phi_,(*selectedLeptons_copy)[1]->phi_),weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][40][n]->Fill(Ht,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][41][n]->Fill(Ms,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][42][n]->Fill(ZlDr,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][43][n]->Fill(ZlDphi,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][44][n]->Fill(JeDr,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][45][n]->Fill(JmuDr,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    HistsSysDown[ch][1][46][n]->Fill(tM,weight_lep * (sysDownWeights[n]/nominalWeights[n]));
    }
    }
    ...
    anti_flavor=(*selectedLeptons)[anti_index]->lep_>1?1:0;
    ...
    HistsAR1[anti_flavor][0][etabin1][0]->Fill((*selectedLeptons)[0]->pt_,(*selectedLeptons)[anti_index]->pt_,weight_lep);
    HistsAR1[anti_flavor][0][etabin1][1]->Fill((*selectedLeptons)[0]->eta_,(*selectedLeptons)[anti_index]->pt_,weight_lep);
    if(selectedJets->size()>0) HistsAR1[anti_flavor][0][etabin1][2]->Fill((*selectedJets)[0]->pt_,(*selectedLeptons)[anti_index]->pt_,weight_lep);
    if(selectedJets->size()>0) HistsAR1[anti_flavor][0][etabin1][3]->Fill((*selectedJets)[0]->eta_,(*selectedLeptons)[anti_index]->pt_,weight_lep);
    HistsAR1[anti_flavor][0][etabin1][4]->Fill(selectedJets->size(),(*selectedLeptons)[anti_index]->pt_,weight_lep);
    HistsAR1[anti_flavor][0][etabin1][5]->Fill(nbjet,(*selectedLeptons)[anti_index]->pt_,weight_lep);
    HistsAR1[anti_flavor][0][etabin1][6]->Fill(MET_pt0,(*selectedLeptons)[anti_index]->pt_,weight_lep);
    HistsAR1[anti_flavor][0][etabin1][7]->Fill(Pileup_nTrueInt,(*selectedLeptons)[anti_index]->pt_,weight_lep);

    if (OnZ){
    HistsAR1[anti_flavor][1][etabin1][0]->Fill((*selectedLeptons)[0]->pt_,(*selectedLeptons)[anti_index]->pt_,weight_lep);
    HistsAR1[anti_flavor][1][etabin1][1]->Fill((*selectedLeptons)[0]->eta_,(*selectedLeptons)[anti_index]->pt_,weight_lep);
    if(selectedJets->size()>0) HistsAR1[anti_flavor][1][etabin1][2]->Fill((*selectedJets)[0]->pt_,(*selectedLeptons)[anti_index]->pt_,weight_lep);
    if(selectedJets->size()>0) HistsAR1[anti_flavor][1][etabin1][3]->Fill((*selectedJets)[0]->eta_,(*selectedLeptons)[anti_index]->pt_,weight_lep);
    HistsAR1[anti_flavor][1][etabin1][4]->Fill(selectedJets->size(),(*selectedLeptons)[anti_index]->pt_,weight_lep);
    HistsAR1[anti_flavor][1][etabin1][5]->Fill(nbjet,(*selectedLeptons)[anti_index]->pt_,weight_lep);
    HistsAR1[anti_flavor][1][etabin1][6]->Fill(MET_pt0,(*selectedLeptons)[anti_index]->pt_,weight_lep);
    HistsAR1[anti_flavor][1][etabin1][7]->Fill(Pileup_nTrueInt,(*selectedLeptons)[anti_index]->pt_,weight_lep);
    }
    }
    //AR2:l\overline{l}\overline{l}
    if (nTight==1){

    if ((*selectedLeptons)[1]->lep_+(*selectedLeptons)[2]->lep_==2||(*selectedLeptons)[1]->lep_+(*selectedLeptons)[2]->lep_==20){
      anti_flavor=(*selectedLeptons)[1]->lep_>1?1:0;
    }
    else{
      anti_flavor=2;
      sort(selectedLeptons->begin()+1, selectedLeptons->end(), CompareFlavourLep);
    }
    ...
    HistsAR2[anti_flavor][0][etabin1][etabin2][0]->Fill((*selectedLeptons)[0]->pt_,(*selectedLeptons)[1]->pt_,(*selectedLeptons)[2]->pt_,weight_lep);
    HistsAR2[anti_flavor][0][etabin1][etabin2][1]->Fill((*selectedLeptons)[0]->eta_,(*selectedLeptons)[1]->pt_,(*selectedLeptons)[2]->pt_,weight_lep);
    if(selectedJets->size()>0) HistsAR2[anti_flavor][0][etabin1][etabin2][2]->Fill((*selectedJets)[0]->pt_,(*selectedLeptons)[1]->pt_,(*selectedLeptons)[2]->pt_,weight_lep);
    if(selectedJets->size()>0) HistsAR2[anti_flavor][0][etabin1][etabin2][3]->Fill((*selectedJets)[0]->eta_,(*selectedLeptons)[1]->pt_,(*selectedLeptons)[2]->pt_,weight_lep);
    HistsAR2[anti_flavor][0][etabin1][etabin2][4]->Fill(selectedJets->size(),(*selectedLeptons)[1]->pt_,(*selectedLeptons)[2]->pt_,weight_lep);
    HistsAR2[anti_flavor][0][etabin1][etabin2][5]->Fill(nbjet,(*selectedLeptons)[1]->pt_,(*selectedLeptons)[2]->pt_,weight_lep);
    HistsAR2[anti_flavor][0][etabin1][etabin2][6]->Fill(MET_pt0,(*selectedLeptons)[1]->pt_,(*selectedLeptons)[2]->pt_,weight_lep);
    HistsAR2[anti_flavor][0][etabin1][etabin2][7]->Fill(Pileup_nTrueInt,(*selectedLeptons)[1]->pt_,(*selectedLeptons)[2]->pt_,weight_lep);

    if (OnZ){
    HistsAR2[anti_flavor][1][etabin1][etabin2][0]->Fill((*selectedLeptons)[0]->pt_,(*selectedLeptons)[1]->pt_,(*selectedLeptons)[2]->pt_,weight_lep);
    HistsAR2[anti_flavor][1][etabin1][etabin2][1]->Fill((*selectedLeptons)[0]->eta_,(*selectedLeptons)[1]->pt_,(*selectedLeptons)[2]->pt_,weight_lep);
    if(selectedJets->size()>0) HistsAR2[anti_flavor][1][etabin1][etabin2][2]->Fill((*selectedJets)[0]->pt_,(*selectedLeptons)[1]->pt_,(*selectedLeptons)[2]->pt_,weight_lep);
    if(selectedJets->size()>0) HistsAR2[anti_flavor][1][etabin1][etabin2][3]->Fill((*selectedJets)[0]->eta_,(*selectedLeptons)[1]->pt_,(*selectedLeptons)[2]->pt_,weight_lep);
    HistsAR2[anti_flavor][1][etabin1][etabin2][4]->Fill(selectedJets->size(),(*selectedLeptons)[1]->pt_,(*selectedLeptons)[2]->pt_,weight_lep);
    HistsAR2[anti_flavor][1][etabin1][etabin2][5]->Fill(nbjet,(*selectedLeptons)[1]->pt_,(*selectedLeptons)[2]->pt_,weight_lep);
    HistsAR2[anti_flavor][1][etabin1][etabin2][6]->Fill(MET_pt0,(*selectedLeptons)[1]->pt_,(*selectedLeptons)[2]->pt_,weight_lep);
    HistsAR2[anti_flavor][1][etabin1][etabin2][7]->Fill(Pileup_nTrueInt,(*selectedLeptons)[1]->pt_,(*selectedLeptons)[2]->pt_,weight_lep);
    }
    }
